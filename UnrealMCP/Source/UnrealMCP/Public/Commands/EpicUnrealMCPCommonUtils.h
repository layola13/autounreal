...
public:
    ...
    static UClass* GetBlueprintGeneratedClassSafe(const UBlueprint* Blueprint);
    static UClass* GetBlueprintCallableClassSafe(const UBlueprint* Blueprint);
    static TSharedPtr<FJsonObject> BlueprintClassInfoToJson(const UBlueprint* Blueprint);
