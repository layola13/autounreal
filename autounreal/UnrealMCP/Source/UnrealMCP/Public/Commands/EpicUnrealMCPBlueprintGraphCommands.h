...
private:
    ...
    // Batch add nodes to Blueprint graph
    TSharedPtr<FJsonObject> HandleAddNodesBatch(const TSharedPtr<FJsonObject>& Params);

    // Batch connect nodes in Blueprint graph
    TSharedPtr<FJsonObject> HandleConnectNodesBatch(const TSharedPtr<FJsonObject>& Params);

    // Batch disconnect node pins in Blueprint graph
    TSharedPtr<FJsonObject> HandleDisconnectNodesBatch(const TSharedPtr<FJsonObject>& Params);

    // Batch delete nodes from Blueprint graph
    TSharedPtr<FJsonObject> HandleRemoveNodesBatch(const TSharedPtr<FJsonObject>& Params);

    // Batch set node pin defaults in Blueprint graph
    TSharedPtr<FJsonObject> HandleSetNodePinDefaultsBatch(const TSharedPtr<FJsonObject>& Params);

    // Aura compatible wrappers
    TSharedPtr<FJsonObject> HandleAddBlueprintNodeToStrand(const TSharedPtr<FJsonObject>& Params);
    ...
    TSharedPtr<FJsonObject> HandleSetNodePinsDefaults(const TSharedPtr<FJsonObject>& Params);
