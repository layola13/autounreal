...
public:
	...
	/**
	 * Creates an Enhanced Input Action node (K2Node_EnhancedInputAction)
	 * @param Graph - The graph to add the node to
	 * @param Params - JSON parameters containing pos_x, pos_y, input_action_path or input_action
	 * @return The created node or nullptr on error
	 */
	static UK2Node* CreateEnhancedInputActionNode(UEdGraph* Graph, const TSharedPtr<class FJsonObject>& Params);
};
